        ...
        <div className="flex h-screen w-screen overflow-hidden bg-[#0a0a0f] text-white font-sans relative">
            ...
            >
                ...
                <div className="p-3 border-t border-[#1e1e2a] space-y-1">
                    <button className="w-full flex items-center gap-3.5 px-3 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-white/[0.03] transition-all group">
                        <User size={18} className="shrink-0 group-hover:scale-110 transition-transform" />
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer group">
                            <div className="text-right hidden xs:block">
                                <div className="text-xs font-bold text-white group-hover:text-[#00d4ff] transition-colors uppercase tracking-tight">Code Student</div>
                                <div className="text-[10px] text-slate-500">Free Tier</div>
                            </div>
                            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-[#1e1e2a] to-[#2a2a3a] border border-[#3a3a4a] flex items-center justify-center group-hover:border-[#00d4ff]/40 transition-all">
